...
export default function InformCompleted() {
    ...
    useEffect(() => {
        apiFetch('/Admin/InformCompleteRepari')
                                        ...
                                        <tr key={request.request_id} className="bg-white border-b dark:bg-gray-800 dark:border-gray-700">
                                            ...
                                            <td className="px-6 py-4">
                                                <a 
                                                    ...
                                                    href={`/Admin/Information/Informcompleted/Cost?repairlog_id=${request.repairlog_id}`}
                                                    onClick={() => localStorage.setItem('repairlog_id', request.repairlog_id)}
                                                    >
