                    ...
                    <div className="container rounded shadow-lg p-5 mt-5 border">
                        ...
                        <div className="flex flex-row justify-center items-center space-x-4">
                            <div className="p-3 border bg-blue-300 text-lg font-medium text-black">
                                <h5 className="mb-2 text-xl font-bold tracking-tight text-gray-900 dark:text-white text-center">ผู้แจ้ง</h5>
                                {alldetail?.requester}
                            </div>
                            <div className="p-3 border bg-yellow-100 text-lg font-medium text-black">
                                <h5 className="mb-2 text-xl font-bold tracking-tight text-gray-900 dark:text-white text-center">ผู้รับแจ้ง</h5>
                                {alldetail?.sup_ke}
                            </div>
                        </div>
                        ...
                        <div className="flex flex-col justify-center items-center">
                            <div className="p-3 border bg-blue-300 text-lg font-medium text-black">
                                <h5 className="mb-2 text-xl font-bold tracking-tight text-gray-900 dark:text-white text-center">ผู้ซ่อม KE</h5>
                                {alldetail?.operator}
                            </div>
                        </div>
                    </div>
