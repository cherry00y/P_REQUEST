...
export default function RequestRepair() {
  ...
  const handleSubmit = async () => {
    ...
    const userId = Cookies.get('userId') || ''; // Correct the key for userId
  ...
  if (loading) {
    return (
      <div className="flex justify-center items-center w-screen h-screen">
        <div className="loader">Loading...</div> {/* Add a loading spinner or message here */}
      </div>
    );
  }
      ...
      <main className="p-4 bg-white flex flex-col flex-1">
        ...
        <div className="flex justify-center items-center w-screen">
          <div className="container rounded shadow-lg p-5 mt-5 border">
            ...
            <div className="mt-4">
              <label htmlFor="issueType" className="block mb-2 text-sm font-medium text-gray-900 dark:text-white">IssueType
                ...
                >
                  ...
                  {issueType.map((type) => (
                    <option key={type.issuetype_id} value={type.issuetype_id}>
                      {type.issuetype_name}
                    </option>
                  ))}
                </select>
            ...
            <div className="mt-4">
              <label htmlFor="problem" className="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Problem Details</label>
              <textarea
                id="problem"
            ...
            <div className="flex items-center mt-4">
              <input
                ...
                className="mr-2"
              />
              <label htmlFor="lineStop" className="text-sm font-medium text-gray-900 dark:text-white">Stop Line</label>
            </div>
