...
export default function RepairAccept() {
    ...
    return(
        <div className="flex flex-col min-h-screen">
            ...
            <main className="p-4 bg-white flex flex-col flex-1">
                <h2  className="text-2xl font-bold ml-20 mt-8">Repair Accept</h2>
                                        ...
                                        <tr key={request.request_id} className="bg-white border-b dark:bg-gray-800 dark:border-gray-700">
                                            ...
                                            <td className="px-6 py-4">
                                                <a 
                                                    ...
                                                    href={`/Worker/RepairRequest/Implement?request_id=${request.request_id}`}
                                                    >
